<template>
  <div class="chart-container" data-cy="chart-data-cell">
    <canvas ref="canvas" width="450" height="70">Lit</canvas>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    // lägg till texten "Lit" efter linjen
    const textAfterLineX = lineAfterLastRingX + 20; // justera X-koordinaten för texten
    ctx.fillText('Lit', textAfterLineX, endY);
